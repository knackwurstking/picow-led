...
func NewColorService(r *Registry) *ColorService {
	return &ColorService{
		registry: r,
	}
}

func (c *ColorService) CreateTable() error {
...
func ScanColor(scannable Scannable) (*models.Color, error) {
	color := &models.Color{}
	err := scannable.Scan(&color.ID, &color.Name, &color.Duty)
	if err != nil {
...
var _ Service = (*ColorService)(nil)
